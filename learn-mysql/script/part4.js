...
*/
const PART4_3 = `insert into user(name, email) values('jung', 'terykid@gmail.com')`;
...
left outer join user on user.id = content.userid`;
...
*/
const PART4_8 = `select title, name from content inner join user on user.id = content.userid`;
...
*/
const PART4_10 = `insert into content(title, body, userId) values('jungwon', 'dbms', 1)`;
